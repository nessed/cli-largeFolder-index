...
def run_channels(root_path, query_terms, limit_per_channel=100, alternative="A"):
...
USE_MULTIQUERY = True  # tuning-loop switch; see corpus-lab/state/evidence_v1/tuning_log.jsonl idea 2
