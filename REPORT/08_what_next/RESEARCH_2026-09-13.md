...
> **Superseded recommendation — 2026-09-13.** The proposed Shelf V2 build is no longer the next action. Subsequent review confirmed that Approach C had already measured the central shelf, BGE semantic-vector, and lexical-plus-semantic RRF route, and it failed the offline discovery gate. See [CORRECTION_2026-09-13.md](CORRECTION_2026-09-13.md). The research body below is retained unchanged as the historical recommendation made before that correction.
